...
if($cat && !is_wp_error($cat)){
    ...
    echo '<div itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="" class="breadcrumb-home"><i class="fa fa-home fa-fw"></i><a href="'.home_url().'" itemprop="url"><span itemprop="title">ホーム</span></a><span class="sp"><i class="fa fa-angle-right"></i></span></div>';
