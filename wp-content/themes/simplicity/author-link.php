...
<span class="post-author vcard author"><span class="fn"<?php is_single() ? '' : ''; ?>><i class="fa fa-user fa-fw"></i><?php
...
<span style="color:red;"><a href="<?php echo site_url('/wp-admin/profile.php'); ?>">プロフィール設定</a>から、「ユーザー名」と「表示名」は異なるものになるよう変更することをお勧めします。（<a href="http://wp-simplicity.com/hide-user-name/">詳細</a>）このメッセージは、通常の訪問者には表示されません。</span>
<?php
else: //通常の投稿者表示 ?>
